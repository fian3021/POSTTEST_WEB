<?php
    ...
    if(isset($_POST['submit'])){
        ...
        $foto_profil = "$nama.$ekstensi";
        
        $tmp = $_FILES['gambar']['tmp_name'];

        if(move_uploaded_file($tmp, "Foto_Profil/".$foto_profil)){
            $query = "INSERT INTO member_istorii (Email, Nama, Usia, Gender, Genre_Favorit, Tanggal_Join, Foto_Profil) 
                        VALUES ('$email', '$nama','$usia','$gender', '".$fav."', '$join', '$foto_profil')";
            ...
            <ul class="join">
                ...
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <table>
                        ...
                        <div class="form">
                            <input type="hidden" name="join[]" value=<?=date("d/m/Y")?>>
                            <input type="hidden" name="join[]" value=<?=date("H:i")?>>
                            <input type="submit" name="submit" class="submit" value="join" />
                        </div>
                    </table>
                </form>
            </ul>
